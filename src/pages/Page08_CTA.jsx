    ...
    <div className="pg">
      <div className="mb-7">
        ...
        <p className="text-[14px] text-dim">
          Select and decide your Call to Action
        </p>
      </div>
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="info-box">
          ...
          <p className="text-[14px] text-dim mb-2">
            Anywhere you see{" "}
            <code className="bg-lifted px-1.5 py-0.5 rounded text-[13px] text-body">
              (insert …)
            </code>{" "}
          ...
          <ul className="flex flex-col gap-1 text-[14px] text-dim">
            <li>
              <strong className="text-body">(insert before state)</strong> =
              problem situation (e.g. "dandruff + itchy scalp")
            </li>
            <li>
              <strong className="text-body">(insert dream result)</strong> =
              desired outcome (e.g. "clean scalp feel" / "visible glow")
            </li>
            <li>
              <strong className="text-body">(insert time frame)</strong> = "7
              days / 14 days / 30 days"
            </li>
            <li>
              <strong className="text-body">
                (insert method/framework/process)
              </strong>{" "}
              = the steps you taught in the video
            </li>
            <li>
              <strong className="text-body">(insert freebie)</strong> = what
              you'll send (PDF, guide, routine, checklist)
            </li>
          </ul>
          <div className="mt-3 p-3 bg-lifted rounded-lg text-[13px] text-dim">
            <strong className="text-body">About "Comment X":</strong> X is
            usually a ManyChat keyword. If you don't use ManyChat, replace with
            "Click the link in bio" or "DM me 'GLOW'".
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          />
          <span className="fh">
            Every CTA must show value · Must lead the customer to your funnel ·
            Connect through WhatsApp · Connect to the campaign URL
          </span>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <select
            className="fi-select"
            value={data.scriptCompleted || ""}
            onChange={set("scriptCompleted")}
          >
